...
public class Casa {
    ...
    static {
        // Nome, VidaMáxima, AtaqueBase, DefesaBase, AlcanceMáximo, ModificadorOfensivo, ModificadorDefensivo
    ...
    public double getModificadorOfensivo() { return modificadorOfensivo; }
    public double getModificadorDefensivo() { return modificadorDefensivo; }

    // Retornando as Casas estáticas
    public static Casa getSTARK() { return STARK; }
    public static Casa getLANNISTER() { return LANNISTER; }
    public static Casa getTARGARYEN() { return TARGARYEN; }
}